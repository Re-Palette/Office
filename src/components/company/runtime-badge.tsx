  ...
  return (
    <div className="border-b border-danger/25 bg-danger/[0.07]">
      <div className="mx-auto flex w-full max-w-[1800px] items-center gap-3 px-4 py-2 lg:px-7 2xl:max-w-[2100px]">
        ...
        <span className="font-mono text-3xs uppercase tracking-[0.18em] text-danger">
          Agent error
        </span>
        <span className="min-w-0 flex-1 truncate text-2xs text-ink-muted">{error}</span>
        <Link
          href="/settings"
          className="shrink-0 font-mono text-3xs uppercase tracking-[0.14em] text-danger hover:underline"
        >
          Settings
        </Link>
        <button
